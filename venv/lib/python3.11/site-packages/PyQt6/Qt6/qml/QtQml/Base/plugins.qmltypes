...
Module {
    ...
    Component {
        ...
        exports: [
            "QtQml.Base/Binding 2.0",
            "QtQml.Base/Binding 2.8",
            "QtQml.Base/Binding 2.14",
            "QtQml.Base/Binding 6.0"
        ]
    ...
    Component {
        ...
        exports: [
            "QtQml.Base/Connections 2.0",
            "QtQml.Base/Connections 2.3",
            "QtQml.Base/Connections 6.0"
        ]
    ...
    Component {
        ...
        exports: ["QtQml.Base/Easing 2.0", "QtQml.Base/Easing 6.0"]
        isCreatable: false
    ...
    Component {
        ...
        accessSemantics: "none"
        extension: "QLocale"
        exports: ["QtQml.Base/Locale 2.2", "QtQml.Base/Locale 6.0"]
        isCreatable: false
    ...
    Component {
        ...
        Property { name: "name"; type: "QString"; read: "name"; index: 5; isReadonly: true; isConstant: true }
        Property {
        ...
        Method { name: "currencySymbol"; type: "QString"; isCloned: true }
        Method {
            name: "dateTimeFormat"
            type: "QString"
            Parameter { name: "format"; type: "QLocale::FormatType" }
        }
        Method { name: "dateTimeFormat"; type: "QString"; isCloned: true }
        Method {
            name: "timeFormat"
            type: "QString"
            Parameter { name: "format"; type: "QLocale::FormatType" }
        }
        Method { name: "timeFormat"; type: "QString"; isCloned: true }
        Method {
            name: "dateFormat"
            type: "QString"
            Parameter { name: "format"; type: "QLocale::FormatType" }
        }
        Method { name: "dateFormat"; type: "QString"; isCloned: true }
        Method {
            name: "monthName"
            type: "QString"
        ...
        Method { name: "formattedDataSize"; isJavaScriptFunction: true }
        Method {
    ...
    Component {
        ...
        interfaces: ["QQmlParserStatus"]
        exports: [
            "QtQml.Base/LoggingCategory 2.8",
            "QtQml.Base/LoggingCategory 2.12",
            "QtQml.Base/LoggingCategory 6.0"
        ]
    ...
    Component {
        ...
        accessSemantics: "reference"
        prototype: "QObject"
        Property { name: "os"; type: "QString"; read: "os"; index: 0; isReadonly: true; isConstant: true }
        Property {
            name: "pluginName"
            type: "QString"
            read: "pluginName"
    ...
    Component {
        ...
        exports: ["QtQml.Base/point 2.0", "QtQml.Base/point 6.0"]
        isStructured: true
        exportMetaObjectRevisions: [512, 1536]
    }
    Component {
    ...
    Component {
        ...
        exports: ["QtQml.Base/rect 2.0", "QtQml.Base/rect 6.0"]
        isStructured: true
        exportMetaObjectRevisions: [512, 1536]
    }
    Component {
    ...
    Component {
        ...
        exports: ["QtQml.Base/size 2.0", "QtQml.Base/size 6.0"]
        isStructured: true
        exportMetaObjectRevisions: [512, 1536]
    }
    Component {
    ...
    Component {
        ...
        prototype: "QObject"
        interfaces: ["QQmlParserStatus"]
        exports: ["QtQml.Base/Timer 2.0", "QtQml.Base/Timer 6.0"]
        exportMetaObjectRevisions: [512, 1536]
        Property {
            name: "interval"
            type: "int"
    ...
    Component {
        ...
        prototype: "QObject"
        exports: [
            "QtQml.Base/TypeNotAvailable 2.15",
            "QtQml.Base/TypeNotAvailable 6.0"
        ]
        isCreatable: false
    ...
    Component {
        ...
        exports: ["QtQml.Base/Qt 2.0", "QtQml.Base/Qt 6.0"]
        isCreatable: false
        isSingleton: true
        exportMetaObjectRevisions: [512, 1536]
        Enum {
